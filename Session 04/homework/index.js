...
//     console.log(`Câu số ${i + 1}`)

// 	console.log(`${footballquiz[i].question}`);
// 	let ans = footballquiz[i].answers;
// 	let cor = footballquiz[i].correct;

// 	for(let a = 0; a < ans.length; a++) {
// 		console.log(`${a + 1}. ${ans[a]}`)
// 	}

// 	let enterAns = prompt('Đáp án của bạn là:');
// 	console.log(`Your answer: ${ans[enterAns - 1]}`);
// 	if(enterAns == cor) {
// 		numberCorrect += 1;
// 		console.log(`>Hura!!!`)
// 	} else {
// 		console.log(`>Not a correct answer :’(`)
// 	}
// //     console.log(footballquiz[i])
// //     let ans = footballquiz[i].answer
// //     let dapan = footballquiz[i].correct
// //    console.log(`${footballquiz[i].answer[1]}`)
// //    console.log(`${footballquiz[i].answer[2]}`)
// //    console.log(`${footballquiz[i].answer[3]}`)
// //    console.log(`${footballquiz[i].answer[4]}`)
